...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 auth-page-bg" style={{background: 'linear-gradient(135deg, #0a1628 0%, #1a2f4a 100%)'}}>
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg auth-card-animate">
        <div>
